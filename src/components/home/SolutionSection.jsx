        ...
        <div className="mx-auto max-w-2xl lg:max-w-7xl">
          <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
            <div className="relative lg:row-span-2">
              <div className="absolute inset-px rounded-lg bg-[#171717] lg:rounded-l-[2rem] border"></div>
            ...
            <div className="relative max-lg:row-start-1">
              <div className="absolute inset-px rounded-lg bg-[#171717] max-lg:rounded-t-[2rem] border"></div>
            ...
            <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
              <div className="absolute inset-px rounded-lg bg-[#171717] border"></div>
            ...
            <div className="relative lg:row-span-2">
              <div className="absolute inset-px rounded-lg bg-[#171717] max-lg:rounded-b-[2rem] lg:rounded-r-[2rem] border"></div>
